...
import { Link, usePathname } from "@/common/i18n/routing";
...
export function AdminSidebar({ userRole }: SidebarProps) {
  ...
  const sidebarLinks = [
    ...
    { href: "/admin/dashboard/my-work", label: t("myWork"), icon: Briefcase },
    { href: "/admin/worklog", label: t("WorkLog.title"), icon: ClipboardList },
    ...
    <div className="hidden border-r bg-muted/40 md:block h-full">
      <div className="flex h-full flex-col gap-2">
        <div className="flex h-14 items-center px-4 lg:h-[60px] lg:px-6">
          <Link
            href="/"
            className="flex flex-col items-start gap-0 font-semibold hover:opacity-90 transition-opacity"
          >

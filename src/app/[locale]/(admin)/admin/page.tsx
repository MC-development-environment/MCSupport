...
import { getDashboardStats, formatDuration } from "@/core/services/dashboard-stats";
    ...
    <div className="flex flex-col gap-4 md:gap-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        <Card
          ...
          className={getGradient("total", stats.totalTickets)}
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              {stats.ticketGrowth.toFixed(1)}% {t("fromLastMonth")}
            </p>
          </CardContent>
        </Card>
        <Card
          x-chunk="dashboard-01-chunk-1"
          className={getGradient("open", stats.openCases)}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {t("openCases")}
        ...
        <Card
          ...
          className={getGradient("time", stats.avgResponseTimeMinutes)}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {t("avgResponseTime")}
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatDuration(stats.avgResponseTimeMinutes)}
            </div>
        ...
        <Card
          ...
          className={getGradient("sat", stats.satisfactionRate)}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {t("customerSat")}
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{t("sysBased")}</p>
          </CardContent>
        </Card>
      </div>
      <div className="grid gap-4 md:gap-8 grid-cols-1 md:grid-cols-3 xl:grid-cols-4">
        <Card
        ...
        <Card className="md:col-span-1" x-chunk="dashboard-01-chunk-5">
          <CardHeader>
